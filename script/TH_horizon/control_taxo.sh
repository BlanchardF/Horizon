...
# Variables
input="/beegfs/data/fblanchard/horizon/TH_horizon/data/${species}/${species}_taxResult_tax_per_contig.tsv"
output="/beegfs/data/fblanchard/horizon/TH_horizon/data/${species}/${species}_taxonomic_assignment_quality.txt"
