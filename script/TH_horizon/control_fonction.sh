...
input_file="/beegfs/data/fblanchard/horizon/TH_horizon/data/epiperola_vaferella/epiperola_vaferella_pred_UniRef_id.txt"
output_file="/beegfs/data/fblanchard/horizon/TH_horizon/data/epiperola_vaferella/uniref_protein_info.txt"
